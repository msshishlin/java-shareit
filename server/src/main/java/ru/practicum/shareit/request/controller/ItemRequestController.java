...
public final class ItemRequestController {
    ...
    public ItemRequestDto createRequest(@RequestHeader(name = "X-Sharer-User-Id") long requesterId,
    ...
    public ItemRequestWithItemsDto getRequest(@RequestHeader(name = "X-Sharer-User-Id") long userId,
